...
class FavoritesBloc extends Bloc<FavoritesEvent, FavoritesState> {
  ...
  Future<void> _fetchFavorites(LoadFavoritesCatalog event, Emitter<FavoritesState> emit) async {
    try {
      final favoritesPaths = await favoritesImageRepo.fetchFavoritedImagePaths();
